...
> **Guard acts last** — after seer. This means if guard protects the wolf target, the protection overrides the kill
...
| 1      | NIGHT 1 / WEREWOLF_PICK              | Alice+Bob: WOLF_KILL(Carol)                                                 | `NightSubPhaseChanged(WITCH_ACT)`                                                                               | Wolves: active                                         |
| 2      | NIGHT 1 / WITCH_ACT                  | Dave: WITCH_ACT(skip)                                                       | `NightSubPhaseChanged(SEER_PICK)`                                                                               | Dave: sees Carol targeted; skips                       |
| 3      | NIGHT 1 / SEER_PICK                  | Carol: SEER_CHECK(Bob)                                                      | `NightSubPhaseChanged(SEER_RESULT)`                                                                             | Carol: active                                          |
| 4      | NIGHT 1 / SEER_RESULT                | Carol: SEER_CONFIRM                                                         | `SeerResult(bob, true)` private; `NightSubPhaseChanged(GUARD_PICK)`                                             | Carol: "Bob — 是狼人！"                                    |
...
| 11     | NIGHT 2 / WEREWOLF_PICK              | Alice+Bob: WOLF_KILL(Carol)                                                 | `NightSubPhaseChanged(WITCH_ACT)`                                                                               | Wolves: target Carol again                             |
| 12     | NIGHT 2 / WITCH_ACT                  | Dave: WITCH_ACT(skip)                                                       | `NightSubPhaseChanged(SEER_PICK)`                                                                               | Dave: skips again                                      |
| 13     | NIGHT 2 / SEER_PICK                  | Carol: SEER_CHECK(Alice)                                                    | `NightSubPhaseChanged(SEER_RESULT)`                                                                             | Carol: active                                          |
| 14     | NIGHT 2 / SEER_RESULT                | Carol: SEER_CONFIRM                                                         | `SeerResult(alice, true)` private; `NightSubPhaseChanged(GUARD_PICK)`                                           | Carol: "Alice — 是狼人！"                                  |
